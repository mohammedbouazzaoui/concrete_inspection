...
from project.pybin.mylib.myfunctions import debug

np.random.seed(42)

DIR_templates = "./project/pybin/templates/"
DIR_static_folder = "./project/static/"
FILE_model = "./project/pybin/models/activemodel_best_trained2"
DIR_images = "./project/data/"
FILE_imgtopredict = DIR_static_folder + "imgtopredict.jpg"

app = Flask( __name__, template_folder=DIR_templates, static_folder = DIR_static_folder )
...
def image_predict():
    ...
    imagefile = DIR_images + imagename
    ...
    debug(DEBUG, predict)
    return render_template(
        "image_show_prediction.html", predict=predict_res, imagename=imagename
    )
